        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EquipmentNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Deliverables_Equipment_EquipmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deliverables_DocumentNumber_Revision",
                table: "Deliverables",
                columns: new[] { "DocumentNumber", "Revision" },
                unique: true,
                filter: "[Revision] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_Deliverables_DocumentType",
                table: "Deliverables",
                column: "DocumentType");

            migrationBuilder.CreateIndex(
                name: "IX_Deliverables_EquipmentId",
                table: "Deliverables",
                column: "EquipmentId");
